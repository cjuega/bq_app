...
public class SortedListAdapter<T> extends BaseAdapter {
	...
	public SortedListAdapter(Context context, int resource, int textViewResourceId, Comparator<? super T> comparator) {
		init(context, resource, textViewResourceId, new ArrayList<T>(), comparator);
	}

	public SortedListAdapter(Context context, int textViewResourceId, T[] objects, Comparator<? super T> comparator) {
		init(context, textViewResourceId, 0, Arrays.asList(objects), comparator);
	}
	
	public SortedListAdapter(Context context, int resource, int textViewResourceId, T[] objects, Comparator<? super T> comparator) {
		init(context, resource, textViewResourceId, Arrays.asList(objects), comparator);
	}
	
	public SortedListAdapter(Context context, int textViewResourceId, List<T> objects, Comparator<? super T> comparator) {
		init(context, textViewResourceId, 0, objects, comparator);
	}
	
	public SortedListAdapter(Context context, int resource, int textViewResourceId, List<T> objects, Comparator<? super T> comparator) {
